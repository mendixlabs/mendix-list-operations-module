...
public final class Sorting {
	...
	public static void objectSortPerformAction(List<IMendixObject> AffectedList,  IMendixObject ObjectToChange, IContext context, String SortAttributeName, Enum_SortingAction Action, boolean Commit) throws Exception{
		...
		case Step_towards_start:{
			Sorting.objectSortStepAction(AffectedList, ObjectToChange, context, SortAttributeName, Action, Commit);
			break;
			}
		...
		case Move_to_start:{
			Sorting.objectMoveToStartAction(AffectedList, ObjectToChange, context, SortAttributeName, Action, Commit);
			break;
			}
		case Move_to_end:{
			Sorting.objectMoveToEndAction(AffectedList, ObjectToChange, context, SortAttributeName, Action, Commit);
			break;
			}
		default:
			break;
	...
	public static void moveToIndex(List<IMendixObject> AffectedList,  IMendixObject ObjectToChangeSingle, IContext context, String SortAttributeName, int NewIndex, boolean Commit) throws Exception{
		...
		if( OldIndex < NewIndex) {
			...
			Sorting.objectMoveToEndAction(SubsetList, ObjectToChangeSingle, context, SortAttributeName, null, Commit);
		}else if(OldIndex > NewIndex){
			List<IMendixObject> SubsetList = AffectedList.subList(NewIndex, OldIndex+1); //subList min is inclusive, max is exclusive
			Sorting.objectMoveToStartAction(SubsetList, ObjectToChangeSingle, context, SortAttributeName, null, Commit);
